...
const namespace = 'deviationDegree';
function deviationDegree({ dispatch, deviationDegree, loading }) {
    const {
        searchParams,
        currentPage,
        pageSize,
...
export default connect(({ deviationDegree, loading }) => ({ deviationDegree, loading }))(
    deviationDegree,
);
