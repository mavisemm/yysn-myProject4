...
const namespace = 'sgStandardStore';
function sgStandardStore({ dispatch, sgStandardStore, loading }) {
    const {
        searchParams,
        currentPage,
        pageSize,
...
export default connect(({ sgStandardStore, loading }) => ({ sgStandardStore, loading }))(
    sgStandardStore,
);
