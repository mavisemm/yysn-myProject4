...
const namespace = 'labelManage';
function labelManage({ dispatch, labelManage, loading }) {
    const {
        searchParams,
        currentPage,
        pageSize,
...
export default connect(({ labelManage, loading }) => ({ labelManage, loading }))(
    labelManage,
);
