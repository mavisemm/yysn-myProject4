...
class Add extends React.Component {
    ...
    render() {
        ...
        const {id,machineList,name,updateItem,ratios,startFreq,endFreq,freqCount,gamma,bj,kaoshi,negRatio,dbP,freqQ,dbWeight,alpha,r} = contentProps;
        return (
            <VtxModal {...modalProps} footer={this.footerRender()}>
                <VtxModalList isRequired visible={modalProps.visible} ref={this.modalListRef}>
                    <div data-modallist={{ layout: { type: 'title', name: '样本参数设置' } }} />
                     <Input
                        value={name}
                        onChange={e => {
                            updateItem({
