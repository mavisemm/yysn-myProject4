...
const namespace = 'pointGroupManage';
function pointGroupManage({ dispatch, pointGroupManage, loading }) {
    const {
        searchParams,
        currentPage,
        pageSize,
...
export default connect(({ pointGroupManage, loading }) => ({ pointGroupManage, loading }))(
    pointGroupManage,
);
